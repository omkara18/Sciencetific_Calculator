...
txtDisplay = Entry(calc, font=('arial',18),
				bg='#4d4d4d',fg='white',
...
btnPM = Button(calc, text=chr(177),width=6,
			height=2,bg='orange', font=('arial',20,'bold'),
...
lblDisplay = Label(calc, text = "Scientific Calculator",
				font=('arial',25),
				bg='#4d4d4d',fg='white',justify=CENTER)
